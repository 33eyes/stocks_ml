...
def list_api_keys():
    """Lists the API names in my_api_keys.json in my home dir."""
    home = str(Path.home())
    with open(home + "/my_api_keys.json") as json_file:
        api_keys = json.load(json_file)

    return list(api_keys.keys())

def get_api_key(api_name):
    """Reads in my API keys from my_api_keys.json in my home dir."""
    home = str(Path.home())
    with open(home + "/my_api_keys.json") as json_file:
        api_keys = json.load(json_file)
